...
This project follows **spec-driven development**: define the specification first, then implement. Spec files live in `.ai/specs/` and serve as the source of truth for design decisions. See `.ai/specs/SPEC_FORMAT.md` for format guidelines.
